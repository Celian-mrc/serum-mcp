...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "paired with global.fx_bus1_volume/fx_bus2_volume) are a rarely-used aux-send "
        "system independent of the main routing above -- leave unset for ordinary "
        "presets, only reach for it when a request specifically calls for a parallel "
        "send/return chain.\n"
