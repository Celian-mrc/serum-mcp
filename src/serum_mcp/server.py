...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "EXPLICIT EXCEPTION: this 'default to more depth' push does NOT extend to `arp` "
        "-- found live 2026-08-05 (a user directly questioning why several bank presets "
        "had it on): unlike every other technique above, enabling `arp` changes how the "
        ...
        "exists to warn against for every OTHER technique. None of this means pad EVERY "
