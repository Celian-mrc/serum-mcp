...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "warp_mode='kGate' produced the expected robotic/gated character; freq_lo/freq_hi/"
        "filter_shift/filter_wet's own calibration is NOT independently verified, treat "
        "with more caution) uses Serum's SPECTRAL engine (SpectralOsc): an absolute path "
