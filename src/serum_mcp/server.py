...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "warp_mode only apply to indices 0-2. sub_shape defaults to 'saw', which is "
        "harmonically bright/aggressive, NOT a clean sub tone -- found live, this made a "
        "layered bass unpleasantly harsh/piercing despite correct pitch. For 'clean', "
        "'warm', 'deep' sub-bass reinforcement (the most common ask for this slot), use "
        "'triangle' instead (closest to a pure tone, least harmonic content); reserve "
        "'saw'/'square'/'pulse' for when the user explicitly wants an aggressive/present/"
        "buzzy sub character.\n"
        ...
        "fine left at their defaults (off / fully wet).\n"
        ...
        "'random_discrete'; destination is a key from "
