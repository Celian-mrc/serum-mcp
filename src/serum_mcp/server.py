...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "list_parameters()['simple_sub_shapes']); table_position/warp_amount/warp_mode "
        "only apply to indices 0-2. unison/detune (indices 0-2) thicken a single "
        "oscillator -- use for 'fat', 'wide', 'supersaw'-style requests. warp_mode "
